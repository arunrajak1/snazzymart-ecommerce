...
const JewelerySection = () => {
  ...
  const jewelery = useSelector((state) => state.products.jewelery);
  ...
  return (
    <div className="font-sans p-4 mx-auto lg:max-w-6xl md:max-w-3xl sm:max-w-12/3 mt-10 mb-10">
      <h2 className="text-4xl font-bold text-gray-800">Jewelery Products</h2>
      ...
      {loading ? (
        ...
        <div className="text-red-500  font-semibold text-center mt-32 text-2xl">Error: {error}</div>
      ) : (

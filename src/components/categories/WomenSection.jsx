...
const WomenSection = () => {
  ...
  }, [dispatch, womensClothing.length]);
  ...
  return (
    <div className="font-sans p-4 mx-auto lg:max-w-6xl md:max-w-3xl sm:max-w-12/3 mt-10 mb-10">
      <h2 className="text-4xl font-bold text-gray-800">Women's Clothing</h2>
      ...
      {loading ? (
        ...
        <div className="text-red-500 text-center font-semibold text-2xl mt-32">Error: {error}</div>
      ) : (

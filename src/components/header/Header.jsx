...
const Header = () => {
  ...
  return (
<header className='flex shadow-lg py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide  sticky top-0  z-50 '>
    <div className='w-full flex flex-wrap items-center lg:gap-y-4 gap-y-6 gap-x-4'>
      <Link to="/"><span className='text-xl font-semibold text-gray-800'>SnazzyMart</span>
      </Link>
      ...
      <div id="collapseMenu"
        ...
        <ul
          className='lg:ml-20 lg:flex lg:gap-x-8 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 mr-20'>
          <li className='mb-6 hidden max-lg:block'>
            <Link to="/"><span className='text-xl font-semibold text-gray-800'>SnazzyMart</span>
            </Link>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:after:absolute lg:after:bg-pink-500 lg:after:w-full lg:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
            <Link  to='category/mens-clothes' className='text-[#333] block text-sm font-semibold'>Men</Link>
          </li>
          <li
            ...
            <Link to='category/womens-clothes' className='text-[#333] block text-sm font-semibold'>Women</Link>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-pink-500 lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
            <Link to='category/electronics' className='text-[#333] block text-sm font-semibold'>Electronics</Link>
          </li>
          <li
            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-pink-500 lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[3px] lg:after:block lg:after:-bottom-2 lg:after:transition-all lg:after:duration-300'>
            <Link to='category/jewelery' className='text-[#333] block text-sm font-semibold'>jewelery</Link>
          </li>
        </ul>
      ...
      <div className='flex items-center ml-auto'>
        <ul className="flex space-x-4">
          ...
          {isModalOpen &&(
              ...
              <button type='button'
                className="bg-transparent border border-gray-300 hover:border-pink-500 px-4 py-2 mt-4 text-sm text-pink-500 font-semibold">LOGIN
                / SIGNUP</button>
              <hr className="border-b-0 my-4" />
              <ul className="space-y-1.5">
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Order</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Wishlist</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Gift Cards</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Contact Us</Link></li>
              </ul>
              <hr className="border-b-0 my-4" />
              <ul className="space-y-1.5">
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Coupons</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Saved Credits</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Contact Us</Link></li>
                <li><Link to='#' className="text-sm text-gray-500 hover:text-pink-500">Saved Addresses</Link>
                </li>
              </ul>
            </div>
          )
          ...
          <li
            className="relative px-1 after:absolute after:bg-pink-500 after:w-0 hover:after:w-full hover:after:h-[3px] after:block after:-bottom-2 after:left-0 after:transition-all after:duration-300">
            <Link to={'/shopping-cart'} className="flex flex-col justify-center items-center cursor-pointer">

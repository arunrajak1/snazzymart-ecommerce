...
const HeroBanner = () => {
  return (
    <div className="container mx-auto pl-10 pr-10 ">
      <h1 className="text-3xl xl:text-4xl text-center font-semibold leading-7 xl:leading-9 text-gray-800 pb-10">
        Deal & Discounts
      </h1>
      <div className="flex items-strech justify-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8 border shadow bg-white">
